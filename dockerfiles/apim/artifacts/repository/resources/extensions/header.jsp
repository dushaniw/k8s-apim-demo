...
<%
  ...
  String headerTitle = "GoGo Transit API Manager";
  String pageTitle = "GoGo Transit API Manager";
  String footerText = "GoGo Transit";
  String faviconSrc = "libs/theme/assets/images/favicon.ico";
  String logoSrc = "extensions/customAssets/logo.svg";
  String logoHeight = "40";
  String logoWidth = "222";
  String logoAltText = "GoGo Transit API Manager";
  File customCSSFile = null;
  String customCSS = "libs/themes/default/custom_theme.css";
