        ...
        <div class="ui container medium center aligned middle aligned">
            ...
            <div class="ui segment">
                ...
                <div class="segment-form">
					...
					<div class="idp">
						<% if (idpName.equals("Google")) { %>
							<img src="images/google.png" width="45" height="45" style="vertical-align:middle;display:inline-box;padding:3px">
						<% } else if (idpName.equals("GitHub")) { %>
							<img src="images/github.png" width="35" height="35" style="vertical-align:middle;display:inline-box;padding:3px">
						<% } %> 
						<span style="">
                                            <%=AuthenticationEndpointUtil.i18n(resourceBundle, "sign.in.with")%> <strong><%=Encode.forHtmlContent(idpName)%></strong></span>
					</div>
                                        </button>
                                    </div>
                                <% } %>
